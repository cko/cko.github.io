...
var _user$project$Type$FetchError = function (a) {
	return {ctor: 'FetchError', _0: a};
};
var _user$project$Type$FetchSuccess = function (a) {
	return {ctor: 'FetchSuccess', _0: a};
};
var _user$project$Type$Fetch = function (a) {
...
var _user$project$View$content = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('main-wrapper')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('ant-row')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('main-container ant-col-xs-24 ant-col-sm-24 ant-col-md-24 ant-col-lg-24')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('ant-menu ant-menu-horizontal ant-menu-light')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Type$Fetch('index.md'))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://github.com')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://twitter.com')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$Main$fetchTask = function (mdfile) {
	return _evancz$elm_http$Http$getString(
		_user$project$Main$url(mdfile));
};
var _user$project$Main$fetchCmd = function (filename) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Type$FetchError,
		_user$project$Type$FetchSuccess,
		_user$project$Main$fetchTask(filename));
};
		...
		switch (_p0.ctor) {
			case 'Fetch':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$fetchCmd(_p0._0)
				};
			case 'FetchSuccess':
				return {
					ctor: '_Tuple2',
					_0: {name: model.name, text: _p0._0},
			...
			default:
				return {
					...
					_0: {
						name: '',
						text: _elm_lang$core$Basics$toString(_p0._0)
					},
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {name: '', text: ''},
	_1: _user$project$Main$fetchCmd('index.md')
};
